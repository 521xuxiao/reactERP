                            ...
                            <div className="div3">
                                <ul className="ul1">
                                    <li className="li1">
                                        ...
                                        <Select disabled={this.state.flag==1?false:true} value={this.state.task} style={{width: '60%'}} onChange={(e)=>{
                            ...
                            <div className="rawMaterial">
                                <div className="placeChangeTable">
                                    <Table pagination={false} dataSource={this.state.modalData}>
                                        ...
                                        <Column title="剩余任务量" dataIndex="remainingLoad" id="remainingLoad" align="center" render={(text, record)=>(
                                            <>
                                                <span>{record.remainingLoad}{record.measurement}</span>
                                            </>
                                        )}/>
